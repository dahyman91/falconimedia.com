...
var navbarLinks = document.getElementsByClassName("navbar-links")[0]; // Hamburger
...
$(document).ready(function () {
  ...
  $(".mailto-message").append(messageCopy); // Disable opening your email client. yuk.
...
$(function () {
  ...
  $window.on("scroll", function () {
    ...
    if (!row.hasClass("visible") && $window.scrollTop() + pad > row.offset().top) {
  ...
  $window.on("scroll", function () {
    ...
    if (!row2.hasClass("visible") && $window.scrollTop() + pad > row2.offset().top) {
